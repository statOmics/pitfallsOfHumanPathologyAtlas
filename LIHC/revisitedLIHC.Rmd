...
get_pvals <- function(i){
    ...
    c <- anova(geneModelWithBase,baseLine_ageBMI)[2,3] # test statistic after age correction
    d <- anova(geneModelWithBase,baseLine_ageBMI)[2,4] # p-value after age correction
